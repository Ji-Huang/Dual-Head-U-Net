...
# pip install kaggle -i http://jfrogreader:AP7SoAxHBehQfx7oGp1VSeCqzm6@jfrog.catlbattery.com/artifactory/api/pypi/pypi-group/simple --trusted-host jfrog.catlbattery.com --upgrade
